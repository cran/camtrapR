...
output: 
  rmarkdown::html_vignette:
    ...
    fig_height: 5
vignette: >
  %\VignetteIndexEntry{Raw camera trap image organisation}
...
In a future release, we plan to offer support for the metadata extraction library. Preliminary test showed that performance increased 2-3 fold.
